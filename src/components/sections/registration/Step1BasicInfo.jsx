...
export const Step1BasicInfo = ({ data, onNext, isChinese }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-8 max-w-2xl mx-auto text-left pb-16">
      {/* 1. About You */}
        ...
        <div className="flex flex-col gap-6">
          ...
          <RadioGroup
            ...
            options={[
              ...
              { label: isChinese ? '不便透露' : 'Prefer not to say', value: 'Prefer not to say' }
            ]}
          />
          ...
          <RadioGroup
            label={isChinese ? '单身时长' : 'How long have you been single?'}
            name="singleDuration"
          ...
          {formData.hasChildren === 'Yes' && (
            <div className="border border-zinc-800 bg-zinc-950/40 p-4 rounded flex flex-col gap-5">
              <RadioGroup
              ...
              <CheckboxGroup
                ...
                options={[
                  ...
                  { label: isChinese ? '成年 (18岁以上)' : 'Adult (18+)', value: 'Adult' }
                ]}
              />
              ...
              <RadioGroup
                ...
                options={[
                  ...
                  { label: isChinese ? '共同监护' : 'Shared custody', value: 'Shared' }
                ]}
              />
            </div>
          )}
          ...
          <RadioGroup
            ...
            options={[
              { label: isChinese ? '学士学位 (Bachelor\'s Degree)' : 'Bachelor\'s Degree', value: 'Bachelor' },
              { label: isChinese ? '硕士学位 (Master\'s Degree)' : 'Master\'s Degree', value: 'Master' },
              { label: isChinese ? '博士学位 (Doctorate / PhD)' : 'Doctorate / PhD', value: 'Doctorate' },
          ...
          <Input
            ...
            placeholder={isChinese ? '例如：执业医师 / 金融风控主管' : 'e.g. Cardiologist / Marketing Director'}
          />
        </div>
      </Card>
      ...
      <Card variant="bordered" className="p-6 bg-[#111111] border-zinc-800/80">
        ...
        <div className="flex flex-col gap-6">
          <RadioGroup
            ...
            options={[
              { label: isChinese ? '严肃长远的婚姻关系 (Serious marriage)' : 'Serious marriage / relationship', value: 'Serious relationship' },
          ...
          <RadioGroup
            label={isChinese ? '是否接受跨地区/跨国情感关系？' : 'Open to international relationship?'}
          ...
          <RadioGroup
            label={isChinese ? '您是否愿意考虑有子女的伴侣？' : 'Would you consider a partner with children?'}
            ...
            options={[
              ...
              { label: isChinese ? '可能愿意' : 'Maybe', value: 'Maybe' },
      ...
      >
        {isChinese ? '保存并继续第二步：深度问卷 →' : 'Continue to Step 2: Deep Profile Qs →'}
      </Button>
    </form>
  );
};
