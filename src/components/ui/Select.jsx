  ...
  return (
    <div className="w-full flex flex-col gap-1.5 text-left">
      ...
      <select
        ref={ref}
        className={cn(
          'w-full px-4 py-2.5 bg-zinc-900 border border-zinc-700/80 text-[#F5F0EB] rounded-2xl focus:outline-none focus:border-[#C0392B] focus:ring-1 focus:ring-[#C0392B] transition-all duration-300 text-sm',
